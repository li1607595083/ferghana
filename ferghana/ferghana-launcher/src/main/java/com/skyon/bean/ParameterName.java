...
public class ParameterName {
    // 数据源输出主键
    public static String SINK_PRIMARY_KEY= "sink_primary_key";
    // 聚合且分区 SQL 语句
    ...
    // 测试环境 redis 连接节点
    public static String TEST_REDIS_NODE = "testRedisNode";
    // 变量 sql
    ...
    public static String TEST_TWO_SOURCE_DATA = "testTwoSourcedata";
