...
public class MainAppIntervalJoin {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Table table1 = dbTableEnv.sqlQuery("SELECT trade_amount, product_no, org.apache.flink.runtime.dispatcher.Dispatcher.getJobMasterGatewayFuturecount(product_no)  over(PARTITION BY product_no ORDER BY order_time RANGE BETWEEN INTERVAL '30' MINUTE preceding AND CURRENT ROW)  AS trade_amount_sum_per_type_001_003  FROM interval_join_001_interval_join_002");


        dbTableEnv.toAppendStream(table1, Row.class, "wc").print();
        dbEnv.execute("test");
