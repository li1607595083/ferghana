...
public class FunKeyedProValCon2 extends KeyedProcessFunction<String, Tuple2<String, String>, String> {
    ...
    private FunKeyedProValCon2(int field_counts) {
     ...
     * @return
     */
    public static FunKeyedProValCon2 of(int field_counts) {
        return new FunKeyedProValCon2(field_counts);
    }
