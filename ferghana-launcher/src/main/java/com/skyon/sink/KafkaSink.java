...
public class KafkaSink {
    ...
    public static FlinkKafkaProducer011<String> transaction(String topic, String brokelist) {
        ...
        FlinkKafkaProducer011<String> output = new FlinkKafkaProducer011<String>(topic, stringKeyedSerializationSchema, properties,FlinkKafkaProducer011.Semantic.EXACTLY_ONCE);
        return output;
    }
